  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.cardBig}>
        <Text style={styles.cardSmallTitle}>Performance Overview</Text>
        <View style={styles.performanceRow}>
          <Text
            style={[
              styles.performanceValue,
              percentPositive ? undefined : { color: "#FF6B6B" },
            ]}
          >
            {percentChange === null
              ? "New"
          ...
          <Text style={styles.performanceSub}>Compared to last week</Text>
        </View>
        <View style={styles.rangeRow}>
          <Text style={styles.rangeNav}>‹</Text>
          <Text style={styles.rangeText}>{currentWeekRange || "--"}</Text>
          <Text style={styles.rangeNav}>›</Text>
        </View>
        <View style={styles.rangeButton}>
          <Text style={styles.rangeButtonText}>Current Week</Text>
        </View>
      </View>
                ...
                return (
                  ...
                  >
                    <View style={[styles.avgLine, { top: yPos }]}>
                      <Text style={styles.avgLabel}>avg {avg}</Text>
                    </View>
                  </View>
                );
              })()
      ...
      <View style={styles.cardBig}>
        <Text style={styles.cardSmallTitle}>Block Consistency</Text>
...
const styles = StyleSheet.create({
  ...
  performanceValue: { color: "#F4C542", fontSize: 28, fontWeight: "800" },
  performanceSub: { color: "#AAA", fontSize: 12, marginLeft: 12 },
  rangeRow: {
    flexDirection: "row",
    alignItems: "center",
  ...
  rangeNav: { color: "#FFF", fontSize: 20, paddingHorizontal: 12 },
  rangeText: { color: "#FFF", fontSize: 14 },
  rangeButton: {
    marginTop: 12,
  ...
  rangeButtonText: { color: "#FFF", fontWeight: "700" },
  chartContainer: {
    height: 220,
    marginTop: 10,
    marginBottom: 24,
  ...
  streak: { color: "#FFF", fontSize: 16, marginTop: 10, textAlign: "center" },
  ...
  cardSubtitle: { color: "#AAA", fontSize: 12, marginTop: 6 },
  tooltip: {
    position: "absolute",
    width: 140,
    backgroundColor: "#111",
  ...
  tooltipClose: { color: "#888", marginTop: 6 },
});
